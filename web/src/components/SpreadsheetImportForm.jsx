...
// Shared by UploadPage (dedicated import flow) and DisparoPage (import inline
// as an alternative to picking an already-imported batch). Calls
// onImported(result) once contacts are persisted - the caller decides what
// happens next (show a summary, or jump straight into contact selection).
export default function SpreadsheetImportForm({ onImported }) {
